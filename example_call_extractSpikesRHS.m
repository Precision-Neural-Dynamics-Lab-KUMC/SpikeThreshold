...
dataPaths.median_path		= [root_data_path 'dataProcessing\SpikeQuality\'];
dataPaths.save_path			= [root_data_path 'dataProcessing\BBtoSpikes\'];
...
extractSpikesRHS(dataPaths, envInfo, strobeInfo, filtInfo)
